...
-- select e.student_id,subject_name,count(*)
-- from Examinations e
-- left join Students s
-- on s.student_id=e.student_id
...
-- select s.student_id,s.student_name,subject_name,ifnull(e.count_,0) as attended_exams
-- from Students s
-- inner join (
-- select student_id,subject_name,count(*) as count_
-- from Examinations
-- group by student_id,subject_name
-- ) as e
...
-- select distinct s.student_id,s.student_name,subject_name,ifnull(count(*),0) as attended_exams
-- from Students s
...
-- select s.student_id,s.student_name,sub.subject_name,attended_exams
-- from Students s
